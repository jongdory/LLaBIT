...
from .brain_vq_dataset import get_extract_vq_fun, get_inject_vq_fun, VQ_IN_REPLACE_TEMPLATE, VQ_OUT_REPLACE_TEMPLATE, VQ_CODE_BOOK_SIZE
...
def load_model_tokenizer_for_generate(
    ...
    # pretrained_lora_name_or_path: str
...
class InstructionTextGenerationPipeline(Pipeline):
    ...
    def preprocess(self, instruction_text, **generate_kwargs):
        ...
        if input_text is None:
            ...
            prompt_text = PROMPT_FOR_GENERATION_FORMAT.format(instruction=instruction_text, input=VQ_IN_REPLACE_TEMPLATE)
        ...
        if isinstance(input_text, list):
            ...
            input_ids = get_inject_vq_fun(self.tokenizer)(input_ids, input_text, VQ_IN_REPLACE_TEMPLATE)
    ...
    def _forward(self, model_inputs, **generate_kwargs):
        ...
        vq = get_extract_vq_fun(self.tokenizer, "output")(generated_sequence)
        if vq is None:
            vq = get_extract_vq_fun(self.tokenizer, "seg")(generated_sequence)

        instruction_text = model_inputs.pop("instruction_text")
        return {"generated_sequence": generated_sequence, "generated_vq": vq, "input_ids": input_ids, "instruction_text": instruction_text}#, "attentions": attentions}
